...
(function () {
    ...
    function init() {
        ...
        //add load more button in the end of page.
    ...
    //onclick in search image to open input search.
    function focusSearch() {
        let input = qs("#inputSearch");
        input.focus();
    }
    //onclick in location image to open input location. 
    function focusPosition() {
        let input = qs("#inputPosition");
        input.focus();
    }
    //onclick in button search, start to search on the title or on the area about input. 
    let bool4 = false;
    function search() {
        let input = qs("#inputSearch");
        let btn1 = qs("#btnL");
        ...
        if (loc !== "") {
            ...
            for (let i = 0; i < jobs.length; i++) {
                ...
                if (!text.includes(loc)) {
                    ...
                    if (bool2 === false) { jobs2[i].style.display = "block"; }
                }
            }
            if (flag2 === 12) { style1(); }
            ...
            for (let i = 0; i < 12; i++) {
                ...
                if (!temp2.includes(temp)) {
                    ...
                    if (bool2 === false) { lement2[i].style.display = "block"; }
                }
                if (flag === object.jobArray.length) { style1(); }
                btn1.style.display = "none";
            }
        }
    }
    //add hidden items to the page onclick any input. 
    function add() {
        let btn1 = qs("#btnL");
        let input = qs("#inputSearch");
        let element = qsa(".job");
    ...
    //to click of checkbox Full Time.
    function full() {
        let input = qs("#inputSearch");
        let input2 = qs("#inputPosition");
        if (input.value === "" && input2.value === "") { fullOnly(); }
        else { fullAndSearch(); }
    }
    //to search Full Time only on the jobs of page.
    let bool = false;
    function fullOnly() {
        let time = qs("#check");
        let btn1 = qs("#btnL");
        ...
        if (bool === false) {
            for (let i = 0; i < 12; i++) {
                ...
                else { element2[i].style.display = "block"; }
            }
            bool = true;
        }
        else {
    ...
    //to search of Full Time jobs about inputs.
    let bool2 = false;
    function fullAndSearch() {
        ...
        if (inputLoc.value !== "") {//to search Full time and area you entered in input location.
            if (bool2 === false) { locAndFull(); bool2 = true; }
            else { locAndNotFull(); bool2 = false; }
        }
        else {//to search Full time and title you entered in input title.
            if (bool2 === false) {
                for (let i = 0; i < 12; i++) {
    ...
    function locAndFull() {
        ...
        for (let i = 0; i < jobs.length; i++) {
            ...
            if (!text.includes(inputLoc.value.toLowerCase())) {
                ...
                else { jobs2[i].style.display = "block"; }
            }
        }
        if (flag === 12) { style1(); }
        btn1.style.display = "none";
    ...
    //onclick in icon dark change page colors. 
    let bool3 = true;
    function igon7() {
        let i = qs("#igon2");
        let i2 = qs("#igon3");
        ...
        if (bool3 === true) {
            ...
            for (let i = 0; i < object.jobArray.length; i++) { p3[i].style.color = "rgb(12, 12, 51)"; }
            for (let i = 0; i < p1.length; i++) { p1[i].style.color = "white"; }
            ...
            for (let i = 0; i < p3.length; i++) { p3[i].style.color = "rgb(82, 82, 201)"; }
            for (let i = 0; i < p1.length; i++) { p1[i].style.color = "rgb(143, 141, 141)"; }
    ...
    //onclick at load more button add jobs to the page.
    let bool5 = false;
    function loadM() {
        let mydiv = qs('.jobContainer');
        let job = qsa(".job1");
        ...
        for (let i = 0; i < job.length; i++) { job[i].style.display = "block"; }
        bool5 = true;
    }
